-- Add `Research` as a valid `agent_tasks.kind`.
--
-- `POST /research/request` enqueues `AgentTaskKind::Research`, but older
-- schemas (through 0005) constrain `agent_tasks.kind` without `Research`.
-- SQLite CHECK constraints require table rebuild to modify allowed values.
